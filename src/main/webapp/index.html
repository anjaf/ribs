                        ...
                        <ul id="global-nav" class="menu">
                            ...
                            <li id="search">
                                ...
                                <div id="search-global-dropdown" class="dropdown-pane" data-dropdown data-options="closeOnClick:true;">
                                    <form id="global-search" name="global-search" action="${pageContext.request.contextPath}/search" method="GET">
                                        <fieldset>
                    ...
                    <form id="ebi_search" action="/ebisearch/search.ebi">
                        <fieldset>
                            <div class="input-group margin-bottom-none margin-top-large">
                                <input id="query" class="input-group-field" title="EB-eye Search" tabindex="1" type="text" name="query" value="" size="35" maxlength="2048" placeholder="Search BioStudies" />
                                <div class="input-group-button">
                        ...
                        <p id="example" class="small">
                            Examples: <a class="" href="/ebisearch/search.ebi?db=allebi&amp;query=keratin&amp;requestFrom=ebi_index">hyperplasia</a>, <a class="" href="/ebisearch/search.ebi?db=allebi&amp;query=bfl1&amp;requestFrom=ebi_index">PMC516016</a>
...
<script id='result-template' type='text/x-handlebars-template'>
    <div class="search-result">
        ...
        <div class="title"><a href="#">{{title}}</a> <span class="accession">{{accession}}</span></div>
    </div>
</script>
