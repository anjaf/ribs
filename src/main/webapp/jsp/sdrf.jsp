...
<t:generic>
    ...
    <jsp:body>
        <div style="text-align: center">
            ...
            <span id="assay-column-legend" style="display: none"><span class="sdrf-assay-column" style="margin-left:20pt; border:1px solid #757EB3; display: inline-block; width:12px; height: 12px;"></span> Assay</span>
        </div>
