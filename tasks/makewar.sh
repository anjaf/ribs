...
sed -i -e "s/@studies.json@/$studiesJsonAddress/g" ./src/main/resources/index.properties
sed -i -e "s/@subfilepath@/$submissionsFilePath/g" ./src/main/resources/index.properties
